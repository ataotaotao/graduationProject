...
#         return comp_best,RMSEP_y0,y0_pre,y_cal_pre , y0_s_test , y1_s_test, RMSEP_y0_
        ...
        print RMSEP_no_trans_0 , "NO_TRANS0"
        print RMSEP_y0 , "rmsep_trans0"
...
def exe_all(i , k , a , b , c):
    # 结果存储路径
    fileName = './result/result_corn_mp6_mp5_no.xlsx'
...
#         print "jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj"
#         print affine_RMSEP , "AFFINE_RMSEP" , RMSEP_SURE
#             print affine_y_predict , y_s_test[:,[3]] , affine_RMSEP[0]
        
#         print affine_RMSEP , "RMSEP_affine"
        
    ###########   7,8,9 ҩƬ
    
#     m_op,RMSEP_tca,y_pre,RMSEC,y_cal_pre_tca = demo.TCA(num , i  , X_master , X_slave , y[:,[i]] ,snv = k )
#     demo.append("TCR" , np.real(RMSEC)[0] , np.real(RMSEP_tca)[0] ,np.real(y_cal_pre_tca) ,np.real(y_pre) , m_op)
#     print   np.real(RMSEP_tca) , "RMSEP_TCA"
#       
#     ######## PDS
#      
# 
...
#     exe_all(0,1 , 20 , 10 , 23)    
#     exe_all(1,1 , 16 , 29 , 11)      
#     exe_all(2,1 , 28 , 22 , 10)       
#     exe_all(3,1 , 27 , 30 , 11)
    # PDS SBC CCA
