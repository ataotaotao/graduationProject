...
#################
        ...
        # ѡ�����
        print y_m_train.shape , y_s.shape
...
#         y_sure_real = y_s_cal_[CalInd_master_std]
        ...
        y0_s_sure = y0_s[276:368,:]
        y1_s_sure = y1_s[276:368,:]
        y_sure_real = y_s_cal_[276:368,:]
...
def exe_all(i , k , a , b , c):
    ...
    ranges = [(360,400) , (13,25) , (150,226) ]
    ranges_y = [(360,405) , (16,23), (150,230)]
...
#         ��һ�ַ���Ӧ�������±궨
    ...
    for j in range(cal_num):
        ...
        if(i == 0 and j == 1) or (i == 1 and j == 2) or (i==2 and j==0):
            ...
            print y_validation_real.shape , "validationshape"
            print y0_s_test[:,0]
